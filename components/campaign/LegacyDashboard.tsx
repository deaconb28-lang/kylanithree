...
import SearchAgainButton from "../dashboard/SearchAgainButton";
import SegmentCard, { type Segment } from "../dashboard/SegmentCard";
...
// The campaign command center, v0.7 — kept behind a flag while v0.8 is built.
//
// Not deleted, for the same reason the legacy onboarding flow was not: shipping the v0.8 dashboard
// in phases means there is a window where the new one is thinner than this, and a rollback that
// requires a revert is not a rollback. `NEXT_PUBLIC_CAMPAIGN_V8` and `?v=` switch between them.
//
// This file is the ORIGINAL command center.
//
