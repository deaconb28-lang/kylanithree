    ...
    <div id="findings" style={{ padding: "96px 5vw", display: "grid", gridTemplateColumns: "1fr minmax(320px,620px)", gap: 72, alignItems: "center", borderTop: "1px solid var(--border)" }} className="rf-grid">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ border: "1px solid var(--border)", borderRadius: 16, padding: "22px 24px", display: "flex", flexDirection: "column", gap: 14, background: "var(--card-alt)", maxWidth: 420 }}>
          ...
          <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 46, letterSpacing: "-.04em", fontVariantNumeric: "tabular-nums", lineHeight: 1 }}>{revenue}</span>
      ...
      <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 18, padding: 30, display: "flex", flexDirection: "column", gap: 22, boxShadow: "var(--lift-3)" }}>
        <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13, letterSpacing: ".09em", textTransform: "uppercase", color: "var(--muted)" }}>Findings · week 3</span>
        <p style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 27, lineHeight: 1.25, letterSpacing: "-.02em" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <div style={{ border: "1px solid var(--border)", borderRadius: 12, padding: 16, display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 26, color: "var(--green)", letterSpacing: "-.03em" }}>18% reply</span>
          ...
          <div style={{ border: "1px solid var(--border)", borderRadius: 12, padding: 16, display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 26, letterSpacing: "-.03em", color: "var(--muted)" }}>3% reply</span>
